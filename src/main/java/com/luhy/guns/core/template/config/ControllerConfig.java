...
public class ControllerConfig {
    ...
    public void init() {
        ...
        this.packageName = "com.luhy.guns.modular." + contextConfig.getModuleName() + ".controller";
        this.controllerPathTemplate = "\\src\\main\\java\\com\\luhy\\guns\\modular\\" + contextConfig.getModuleName() + "\\controller\\{}Controller.java";
    }
